...
typedef struct
{
   long timestamp; /* alert time in nanoseconds*/
...
/*F*/
int lgGroupRead(int handle, int gpio, long *groupBits);
/*D
...
/*F*/
int lguGetInternal(int cfgId, long *cfgVal);
/*D
...
/*F*/
int lguSetInternal(int cfgId, long cfgVal);
/*D
